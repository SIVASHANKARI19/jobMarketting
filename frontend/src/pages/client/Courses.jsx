...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center text-white p-6">
      ...
      {/* Input Section */}
      <div className="w-full max-w-3xl flex items-center justify-center mb-10 rounded-2xl shadow-xl overflow-hidden border border-black/20">
        <input
          type="text"
          value={skills}
          onChange={(e) => setSkills(e.target.value)}
          placeholder="Type your skills (e.g. Python, SQL, Data Analysis)"
          className="flex-1 bg-transparent text-white placeholder-gray-400 px-6  text-lg outline-none"
        />
        <button
